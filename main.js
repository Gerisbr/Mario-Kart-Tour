  ...
  if (lname==''){
    ...
    function UserTimer() {
      if (linestep==1){
        ...
        document.getElementById("text-gen-loading").innerHTML="Locating Mario Kart Tour Games " +username+" (attempt 1)...";
      }else if(linestep==5){
        document.getElementById("text-gen").style.display="block";
        document.getElementById("text-gen-loading").innerHTML="Locating Mario Kart Tour Games " +username+" (attempt 2)...";
      }
      else if(linestep==6){
